using AppartmentSystem.ManageLease;
...
namespace AppartmentSystem
{
    public partial class Lease : Form
    {
        ...
        private void ManageLease_Load(object sender, EventArgs e)
        {
            ...
            btn_addLease.Region = Region.FromHrgn(CreateRoundRectRgn(0, 0, btn_addLease.Width,
            btn_addLease.Height, 15, 15));
        ...
        private void btn_addLease_Click_1(object sender, EventArgs e)
        {
            ...
            frm_addTenant attenant = new frm_addTenant();
            attenant.Show();
            this.Close();
        }
